        ...
        SimpleDataTable.initializeWithColumns("crf_trialsDT", "table#medical_trials_datatable", "MedicalTrial", [
            ...
            { "data": "description", "name": "Description", "autoWidth": true, "sortable": false },
            {
                "render": function (data, type, object, meta) {
                    return '<a class="btn btn-info details-link disable-default show-trial" data-what="item" data-klass="MedicalTrial" data-tab="medical-trials" style="display: none" data-role="Delete Role" href="/MedicalTrials/Show/' + object.id + '" data-id="' + object.id + '"><i class=\'fa fa-eye\' ></i>&nbsp;Show</a>&nbsp;' +
