...
{
    public class EPRLymphocytesImporter : Importer
    {
        ...
        public EPRLymphocytesImporter(FileStream stream,
                             IFormFile file,
                             ...
                             AspergillosisContext context)
        {
            ...
            _uom = context.UnitOfMeasurements.Where(uom => uom.Name == "x10^9/l").FirstOrDefault();
        }
        ...
        {
            _uom = _context.UnitOfMeasurements.Where(uom => uom.Name == "x10^9/l").FirstOrDefault();
