...
{
    public class EPRCReactiveProteinImporter : Importer
    {
        ...
        public EPRCReactiveProteinImporter(FileStream stream, IFormFile file,
                                           ...
                                           AspergillosisContext context)
        {
            ...
            _uom = context.UnitOfMeasurements.Where(uom => uom.Name == "mg/L").FirstOrDefault();
        }
        ...
        {
            _uom = _context.UnitOfMeasurements.Where(uom => uom.Name == "mg/L").FirstOrDefault();
            ...
            var testType = _context.TestTypes
                                   .Where(tt => tt.Name == "C-Reactive Protein (CRP)")
                                   .FirstOrDefault();
